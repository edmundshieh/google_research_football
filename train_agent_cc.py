...
from rldm.scripts.centralized_critic_models import YetAnotherTorchCentralizedCriticModel
from rldm.scripts.centralized_critic_2 import central_critic_observer
...
def main(n_cpus, n_gpus, env_name,
    ...
    observer_space = Dict({
        "own_obs": obs_space['player_0'],
        # These two fields are filled in by the CentralCriticObserver, and are
        # not used for inference, only for training.
        # "teammate_obs": obs_space['player_0'],
        "teammate_action": act_space['player_0'],
    })    

    policies = {
    'player_0' : (None, observer_space, action_space, {}),
    'player_1' : (None, observer_space, action_space, {}),
    }
    ...
    PBTscheduler = PopulationBasedTraining(
        ...
        mode='max',
        perturbation_interval=50000, # You may adjust this interval as needed
